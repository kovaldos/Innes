...
headerMenuLinks.forEach(function (link) {
  link.addEventListener('mouseover', onMenuMouseOver);
  link.addEventListener('mouseout', onMenuMouseOut);
});
headerLogo.addEventListener('mouseover', onMenuMouseOver);
headerLogo.addEventListener('mouseout', onMenuMouseOut);
/* Ковер лого Конец */
